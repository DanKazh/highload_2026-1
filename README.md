...
| **Среднее количество регистраций в день** | 25 тыс | Общее количество пользователей составляет 58.6 млн, рост аудитории составляет ~30% в год [[11](https://app2top.com/news/the-number-of-vk-play-accounts-increased-by-almost-30-over-the-year-however-mau-dropped-by-1-7-million-278885.html?utm_source=chatgpt.com)], что эквивалентно 9.2 млн новых пользователей в год |
...
| api.vkplay.ru | Бэкенд-API для социальных функций, авторизации |
...
| :--- | :--- | :--- |
| Москва | 40% | 206 |
| Санкт-Петербург | 34% | 175 |
| Пермь | 17% | 88 |
| Новосибирск | 9% | 46 |

Москва и Санкт-Петербург обслуживают пересекающуюся аудиторию (запад России), поэтому их суммарная доля пользователей (74% - [[10](https://kulturologia.ru/news/7431/)]) распределена не по доле пользователей каждого региона. 
